...
<div class="container-fluid p-0">
    <div class="card bg-white border-0 shadow-sm col-lg-8 mx-auto">
        <div class="card-header bg-white border-0 py-3">
            <h5 class="card-title fw-bold mb-0 text-dark"><i class="fas fa-edit me-2 text-primary"></i>Modifier la Ressource</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.resources.update', $resource->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="titre" name="titre" placeholder="Entrez le titre..." value="{{ old('titre', $resource->titre) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="type" name="type" required>
                        ...
                        <option value="contact" {{ old('type', $resource->type) === 'contact' ? 'selected' : '' }}>Contact d'urgence</option>
                    </select>
                </div>

                <div class="mb-3">
                    <label for="url" class="form-label fw-semibold">URL / Lien (Optionnel)</label>
                    <input type="url" class="form-control" id="url" name="url" placeholder="https://example.com/..." value="{{ old('url', $resource->url) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Description de la ressource ou numéro/informations si c'est un contact d'urgence...">{{ old('description', $resource->description) }}</textarea>
                </div>
